...
export default function MensToys() {
  const allProducts = productsData.mens_toys.slice(0, 16);
  /* Sliced and commented out remaining products:
  const remainingProducts = [
    { sku: 1019, name: "Penis Enlargement Pump For Men", price: 2499 },
    { sku: 1020, name: "zamba mia cup adult love doll silicone male masturbator mini sex doll For Men", price: 2199 },
    { sku: 1021, name: "Masturbator cup 6.5 inch For Men", price: 1249 },
    { sku: 1022, name: "Baile Masturbator Cup For Men", price: 2299 },
    { sku: 1026, name: "male handjob masturbator cup sex toys for men pocket pussy, silicone stroker", price: 1799 },
    { sku: 1027, name: "zamba Fleshlight Girls Angel Youngs Sweetness Vagina Mastürbatör for men", price: 2999 },
    { sku: 1030, name: "zamba male masturbator automatic cup squeeze voice vibration...", price: 3999 },
    { sku: 1031, name: "zamba air tech sexy handjob cup male masturbator realistic oral...", price: 1999 },
    ...
    { sku: 1042, name: "zamba 7 inch remote control vibrating suction dildo for women", price: 3399 },
    ...
    { sku: 1051, name: "zamba Sucking Rose G Spot Vibrator For Women", price: 4499 },
    ...
    { sku: 1068, name: "Vibrator Rabbit Vibrator G-Spot Vibrator...", price: 4499 },
    ...
    { sku: 1083, name: "10 Modes Wireless Battery Operated Vibrating Egg...", price: 2999 },
    { sku: 1084, name: "zamba Wireless premium vib massager with remote...", price: 3499 },
    ...
    { sku: 1089, name: "zamba Luv Link Silicon Vibrator...", price: 2499 }
  ];
  */
      ...
      >
        ...
        <div
          style={{
            position: "absolute",
            inset: 0,
            background: "linear-gradient(135deg, rgba(30,13,56,0.85) 0%, rgba(26,10,46,0.68) 50%, rgba(0,0,0,0.45) 100%)",
            zIndex: 1,
          }}
        />
        {/* Text Content */}
        <div className="hero-content" style={{ position: "relative", zIndex: 2, margin: "0 auto", textAlign: "center" }}>
          <span className="hero-tag">For Him</span>
          <h1 className="hero-title" style={{ fontSize: "44px" }}>Men's Pleasure Toys</h1>
          <p className="hero-sub" style={{ margin: "0 auto", fontSize: "16px" }}>
            Explore our curated catalog of high-quality, body-safe sleeves, strokers, masturbators, and chastity devices. 100% discreetly packaged.
          </p>
        </div>
      </section>
      ...
      <footer>
        <div className="footer-grid">
          ...
          <div className="footer-col">
            <h4>Shop Intimate</h4>
            <ul>
              <li><a href="#">Sleeves & Extenders</a></li>
              <li><a href="#">Automatic Strokers</a></li>
              <li><a href="#">Masturbator Cups</a></li>
              <li><a href="#">Chastity Devices</a></li>
            </ul>
          </div>
          <div className="footer-col">
            <h4>Discreet Help</h4>
