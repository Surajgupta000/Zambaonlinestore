...
export default function CoupleToys() {
  const allProducts = productsData.couple_toys.slice(0, 16);
  /* Sliced and commented out remaining products:
  // There are no remaining products beyond the 16 limit (total 11).
  */
  ...
  return (
    <div style={{ position: "relative", minHeight: "100vh" }}>
      ...
      {/* HERO / BANNER SECTION */}
      <section className="hero" style={{ minHeight: "360px", background: "linear-gradient(135deg, #1C0A38 0%, #150529 100%)" }}>
        <div className="hero-content" style={{ margin: "0 auto", textAlign: "center", zIndex: 10 }}>
          <span className="hero-tag">For Couples</span>
          <h1 className="hero-title" style={{ fontSize: "44px" }}>Couple Toys</h1>
          <p className="hero-sub" style={{ margin: "0 auto", fontSize: "16px" }}>
            Discover our premium selection of partner vibrators, remote control toys, strap-ons, and massage candle kits designed to enhance bonding and bonding pleasure. 100% discreetly packaged.
          </p>
        </div>
      </section>
      ...
      <footer>
        <div className="footer-grid">
          ...
          <div className="footer-col">
            <h4>Shop Intimate</h4>
            <ul>
              <li><a href="#">Remote Vibrators</a></li>
              <li><a href="#">Strap-On Sets</a></li>
              <li><a href="#">Couple Stimulation Rings</a></li>
              <li><a href="#">Sensory Bonding Kits</a></li>
            </ul>
          </div>
          <div className="footer-col">
            <h4>Discreet Help</h4>
